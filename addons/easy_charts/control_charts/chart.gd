...
onready var plot_box: PlotBox = $Canvas/CanvasContainer/DataContainer/PlotContainer/PlotBox
onready var grid_box: GridBox = $Canvas/CanvasContainer/DataContainer/PlotContainer/PlotBox/GridBox/
onready var functions_box: Control = $Canvas/CanvasContainer/DataContainer/PlotContainer/PlotBox/FunctionsBox
onready var function_legend: FunctionLegend = $Canvas/CanvasContainer/DataContainer/FunctionLegend
